...
module.exports = {
  apps: [
    ...
    },
    {
      ...
      args: [
        "--noprofile", "--norc", "-c",
        `"${PYTHON}" -m limitless_hl.learner --db tmp/limitless_hl/learner.sqlite3 --log tmp/limitless_hl/daemon_trades.jsonl --log tmp/limitless_hl/funding_trades.jsonl --seed-report data/evaluation_report_strict.json --report-out tmp/limitless_hl/evaluation_report_live.json --loop-seconds 45`,
      ],
      autorestart: true,
      restart_delay: 10000,
      max_restarts: 20,
    ...
    },
    {
      ...
      args: [
        "--noprofile", "--norc", "-c",
        `LIMITLESS_MAKER_ADDRESS=${LIMITLESS_MAKER_ADDRESS} "${PYTHON}" -m limitless_hl.claimer --live --log-dir tmp/limitless_hl --loop-seconds 60 --jsonl-out tmp/limitless_hl/claims.jsonl`,
      ],
      autorestart: true,
      restart_delay: 10000,
      max_restarts: 20,
    ...
    },
    {
      ...
      args: [
        "--noprofile", "--norc", "-c",
        `${LIMITLESS_ENV} "${PYTHON}" -m limitless_hl.funding_daemon --stake-usdc 1 --max-daily-loss-usdc 10 --loop-seconds 20 --min-seconds-to-expiry 120 --jsonl-out tmp/limitless_hl/funding_dry.jsonl`,
      ],
      autorestart: true,
      restart_delay: 10000,
      max_restarts: 20,
    ...
    },
    {
      ...
      args: [
        "--noprofile", "--norc", "-c",
        `"${PYTHON}" -m limitless_hl.cli --iterations 0 --interval-seconds 20 --jsonl-out tmp/limitless_hl/overnight_dry_run_strict.jsonl --min-edge 0.08 --stake-usdc 1 --min-size-usdc 1 --min-seconds-to-expiry 180 --max-price 0.85`,
      ],
      autorestart: true,
      restart_delay: 5000,
      max_restarts: 50,
