...
- Public docs URL: `https://samlogic-ship.github.io/limitless-hl-bot/`.
- Adoption surface: the generated site is published from the target repository itself after merged adoption PRs #1 and #2, and the target README links to that exact project-owned GitHub Pages path.
...
- Verification: `runx:receipt:sha256:bf8f6632a4a6111932f00f955bc3133d42e38bc7beea6c2f82b58a48a6c698e4` from runx-cli 0.7.1; local verification reports `valid: true`.
